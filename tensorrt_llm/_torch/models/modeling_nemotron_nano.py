...
class DynamicResolutionImageTiler:
    ...
    def process_media(
        ...
        """Process a single image: compute target dimensions preserving aspect ratio."""
    ...
    def stack(images: List[torch.Tensor], patch_size: int) -> torch.Tensor:
        ...
        def rearrange_img(x: torch.Tensor) -> torch.Tensor:
...
class NanoV2VLVisionEncoder(transformers.PreTrainedModel):
    ...
    def forward(
        ...
        # Check if any request uses dynamic resolution.
        has_dynamic = any(
