...
from tensorrt_llm.serve.openai_protocol import (ChatCompletionRequest,
                                                ...
                                                ToolCall)
from tensorrt_llm.serve.tool_parsers.abstract_tool_parser import (
    ExtractedToolCallInformation, ToolParser, ToolParserManager)
from tensorrt_llm.serve.tool_parsers.utils import (find_common_prefix,
                                                   is_complete_json,
                                                   partial_json_loads)


# Copy-pasted from vllm/entrypoints/chat_utils.py and vllm/utils/__init__.py.
def random_uuid() -> str:
